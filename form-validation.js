(function(window, jQuery) {
    ...
    function fe(el, options) {
        ...
        this.init = function(ln) {
            ...
            if (this.options.reactive_form) {
                $all_elements = $(this.el.elements);
                $all_elements.each(function(i, val) {
                    $this = $(this);
                ...
                $(window).resize(function() {
                    $all_elements.each(function(i, val) {
                        var $isValidated = $(this).closest('.fe-validated').length;
    ...
    fe.prototype.addSuccess = function(el) {
        ...
        $par.addClass('fe-suc').addClass('fe-validated');
    ...
    fe.prototype.addError = function(el, error_message) {
        ...
        $par.addClass('fe-error').addClass('fe-validated');
        var cl = $el.attr('name');
